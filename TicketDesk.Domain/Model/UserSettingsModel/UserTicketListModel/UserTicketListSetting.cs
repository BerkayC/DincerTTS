    ...
    public class UserTicketListSetting
    {
        ...
        internal static List<UserTicketListSetting> GetDefaultListSettings(string userId, bool isHelpDeskUserOrAdmin)
        {
            ...
            if (isHelpDeskUserOrAdmin)
            {
                ...
                var AllSortColumns = new List<UserTicketListSortColumn>();
                var AllFilterColumns = new List<UserTicketListFilterColumn>();
                AllSortColumns.Add(new UserTicketListSortColumn("TicketStatus", ColumnSortDirection.Ascending));
                settings.Add(new UserTicketListSetting("alltickets", DefaultListName["alltickets"], disOrder++, 20, AllSortColumns, AllFilterColumns, new List<string> { "" }));
        ...
        internal static IDictionary<string, string> DefaultListName
        {
            get
            {
                return new Dictionary<string, string>()
                {
                    ...
                    {
                        "alltickets",
                        Strings.DefaultListNameAllTickets
                    },
                    {
                        "assignedToMe",
